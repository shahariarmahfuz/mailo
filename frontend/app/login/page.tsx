    ...
    <div className="min-h-screen flex flex-col justify-center items-center px-4 bg-slate-950">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-400 mt-1">Sign in to access your mailboxes and inbox</p>
        </div>
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 sm:p-8 shadow-xl backdrop-blur">
          ...
          <div className="mt-6 pt-5 border-t border-slate-800/80 text-center text-xs text-slate-400">
            ...
            <Link href="/signup" className="text-blue-400 hover:text-blue-300 font-semibold underline underline-offset-2">
              Create an account
            </Link>
          </div>
        </div>
